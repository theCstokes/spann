...
This document describes the requirements for Spann.  The template for the
...
\section{Functional Requirements}
  ...
  \subsection{Functional Requirements}
	\begin{description}
		\item [Editing] The application shall allow the user to edit and save new
			and existing files.
		\item [Editing Support] The application shall provide the user with
			language specific suggestions while the user is editing a file.
		\item [File Handling] The application shall manage (store, track) files
			created by the user.
		...
		\item [Networking] The application shall execute the code and store user
			...
			connection.
		\item [Accounts] The application shall allow new users to create an account and allow existing users to login into their user account.
		\item [Account Mangement] The application shall allow the user to manage their accounts through a user interface on the application (manage account details such as password, email, etc.).
	\end{description}
